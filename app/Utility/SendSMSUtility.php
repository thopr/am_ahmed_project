        ...
        if($from=='whatsapp'){
            ...
            if (OtpConfiguration::where('type', 'twillo')->first()->value == 1) {
                ...
                try {
                    ...
                    $message=  $client->messages->create(
                        ...
                        array(
                            'from' => "whatsapp:".env('VALID_TWILLO_NUMBER'), // From a valid Twilio number
                            'body' => $text
                        )
                    );
    
    
                    Storage::disk('local')->put('message.txt', $message);
            ...
            if(env("SMS_ACTIVE")==true){
               ...
               // $to='966537266754';
                ...
                $url = "https://el.cloud.unifonic.com/wrapper/sendSMS.php";
