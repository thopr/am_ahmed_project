...
class AttributeController extends Controller
{
    ...
    public function index()
    {
        ...
        $attributes = Attribute::orderBy('created_at', 'desc')->with('category')->get();
