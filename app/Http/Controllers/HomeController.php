...
class HomeController extends Controller
{
    ...
    public function cart_login(Request $request)
    {
        ...
        if($user != null){
           // "password" => "$2y$10$del/f1tLDHWGEKpKfKXDqOoWpJ5wYTBsadNKZg6HrQKCsLLbw7URG"
            ...
            if(Hash::check($request->password, $user->password)){
                ...
                if($request->ztype_check=='dashboard'){
                    return redirect()->route('dashboard');
                  }elseif($request->ztype_check=='cart'){
            ...
            return view('frontend.user_phone_v', compact('phone','mycheck'));
           // return back();
...
//        $categories = Category::where('level', 0)->orderBy('name', 'asc')->get();
    ...
    public function variant_price(Request $request)
    {
        ...
        if(json_decode($product->choice_options) != null){
            ...
            foreach (json_decode($product->choice_options) as $key => $choice) {
                ...
                if($str != null){
                    $str .= '-'.$request['attribute_id_'.$choice->attribute_id];
                }
                else{
                    $str .=$request['attribute_id_'.$choice->attribute_id];
                }
    ...
    public function pick_up_points(Request $request)
    {
        $pick_up_points = PickupPoint::all();
    ...
    public function loginjustphone3(Request $request)
    {

  $request_phone='966'.$request->phone;
  
  
        $user = User::whereIn('user_type', ['customer', 'seller'])->where('phone', $request_phone)->first();
