                        ...
                        <div class="text-left">
                            ...
                            <form id="option-choice-form">
                                ...
                                @if ($detailedProduct->choice_options != null)
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-sm-2">
                                            <div class="h6  my-2 text-primary">{{ \App\Models\Attribute::find($choice->attribute_id)->getTranslation('name') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                            <div style="display:grid" class="aiz-radio-inline mb-4">
                                                @foreach ($choice->values as $key => $value)
                                                @php $value=explode( ":", $value);@endphp
                                                <label class="aiz-megabox pl-0 mr-2">
                                                    ...
                                                    <span  style="border-width: 3px ;" class="aiz-megabox-elem rounded d-flex align-items-center justify-content-center py-2 px-3 mb-2">
                                                        {{ $value[0].' '  }} @if($value[1]>0)  <span style="color:gray" class=" fw-600  ">{{ ' + '.single_price($value[1] ) }} </span> @endif
                                                    </span>
                                                </label>
                                                @endforeach
                                            </div>
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    <button type="button" class="btn btn-link btn-icon-left fw-600 d-none" onclick="addToCompare({{ $detailedProduct->id }})">
                    ...
                    @if ($detailedProduct->added_by == 'seller' && $detailedProduct->user->seller != null)
                        <div class="bg-white shadow-sm mb-3">
                            <div class="position-relative p-3 text-left">
                                ...
                                <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}" class="text-reset d-block fw-600 d-none">
