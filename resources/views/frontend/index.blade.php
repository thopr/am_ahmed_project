                ...
                <div class="col-lg-2 order-3 mt-3 mt-lg-0">
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="c-scrollbar-light overflow-auto h-lg-400px p-2 bg-primary rounded-bottom">
                            <div class="gutters-5 lg-no-gutters row row-cols-sm-1 row-cols-lg-1">
                                    ...
                                    <a href="{{ route('product', $product->slug) }}" class="d-block p-2 text-reset bg-white h-100 rounded">
                                        <div class="row gutters-5 align-items-center">
                                            <div class="col-xxl">
                                                <div class="img">
                                                    <img
                                                        class="lazyload img-fit h-300px h-lg-80px"
                                                        src="{{ static_asset('assets/img/placeholder.jpg') }}"
...
<div class="container mb-4">
    <a href="{{ get_setting('app_store_link') }}" target="_blank" class="d-inline-block">
        <img src="{{ static_asset('assets/img/whatsapp.png') }}" class="mx-100 whatsapp-icon ">
    </a>
</div>
    {{-- Banner section 1 --}}
