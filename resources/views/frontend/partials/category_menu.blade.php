<div style="font-size: 18px;" class="aiz-category-menu bg-white rounded @if(Route::currentRouteName() == 'home') shadow-sm" @else shadow-lg" id="category-sidebar" @endif>
    ...
    <ul  class="list-unstyled categories no-scrollbar py-2 mb-0 text-left">
        @foreach (\App\Models\Category::where('level', 2)->orderBy('order_level', 'desc')->get()->take(11) as $key => $category)
