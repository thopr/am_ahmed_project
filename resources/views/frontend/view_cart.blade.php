                    ...
                    <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
                        <div class="mb-4">
                            <div class="row gutters-5 d-none d-lg-flex border-bottom mb-3 pb-3">
                                ...
                                <div class="col fw-600">{{ translate('Price Options included')}}</div>
        ...
        <div class="modal-dialog modal-dialog-zoom">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h6 class="modal-title fw-600"> {{ translate('Enter your phone number to continue') }}</h6>
                ...
                <div class="modal-body">
                    <div class="p-3">
                   <form class="form-default" role="form" action="{{ route('loginjustphone') }}" method="GET">
                                        @csrf
                                        ...
                                        <div class="form-group ">
                                            <input type="hidden" class="form-control "  name="cart_check" value="cart">
                                        </div>
                                        ...
                                        <div class="mb-5 ">
                                            <button type="submit" class="btn btn-primary btn-block fw-600">{{  translate('Continue') }}</button>
                                        </div>
                                    </form>
