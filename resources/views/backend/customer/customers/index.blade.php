            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="d-none" data-breakpoints="lg">{{translate('Email Address')}}</th>
                        <th data-breakpoints="lg">{{translate('Phone')}}</th>
                        <th  class='d-none' data-breakpoints="lg">{{translate('Package')}}</th>
                        <th  class='d-none'data-breakpoints="lg">{{translate('Package')}}</th>
                    ...
                    @foreach($users as $key => $user)
                        @if ($user != null)
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="{{route('customers.login', encrypt($user->id))}}" class="btn btn-soft-primary btn-icon btn-circle btn-sm d-none" title="{{ translate('Log in as this Customer') }}">
