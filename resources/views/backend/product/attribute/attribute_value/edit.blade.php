    ...
    <div class="card">
        <div class="card-body p-0">
          ...
          <form class="p-4" action="{{ route('update-attribute-value', $attribute_value->id) }}" method="POST">
              ...
              <div class="form-group row">
                <label class="col-sm-3 col-from-label" for="Defulte Price">
                    {{ translate('Defulte Price')}} 
                </label>
                <div class="col-sm-9">
                    <input type="text" placeholder="{{ translate('Price')}}" id="price" name="price" class="form-control" required value="{{ $attribute_value->price }}">
                </div>
            </div>
