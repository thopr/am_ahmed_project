            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-success btn-icon btn-circle btn-sm d-none"  href="{{ route('product', $product->slug) }}" target="_blank" title="{{ translate('View') }}">
                            ...
                            @endif
                            <a class="btn btn-soft-warning btn-icon btn-circle btn-sm d-none" href="{{route('products.duplicate', ['id'=>$product->id, 'type'=>$type]  )}}" title="{{ translate('Duplicate') }}">
