                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="small_summary" value="{{ $product->small_summary}}" placeholder="{{ translate('Small Summary') }}"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="main_category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" onchange="update_children()" name="main_category_id" id="main_category_id" data-live-search="true" required>
                                    ...
                                    <option @if($category->id == $product->main_category_id) selected @endif value="{{ $category->id }}">{{ $category->getTranslation('name') }}</option>                     
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="category_id" id="category_id" data-selected="{{ $product->category_id }}" data-live-search="true"  required>
                                   ...
                                   @php $sub_categories= \App\Models\Category::where('id', $product->main_category_id)->with('childrenCategories')->first();

                                   @endphp
                                 
                                   @foreach ($sub_categories->childrenCategories as $childCategory)
                        ...
                        <div class="form-group row" id="main_category">
                            ...
                            <div class="col-md-8">
                                @php $cities_ids= \App\Models\CityProduct::where('product_id', $product->id)->pluck('city_id')->toArray();
                                ...
                                <select class="form-control aiz-selectpicker"  name="cities[]" id="cities"   data-live-search="true" multiple required>
                                    ...
                                    <option @if(in_array($city->id, $cities_ids)) selected @endif value="{{ $city->id }}">{{ $city->getTranslation('name') }}</option>                     
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="main_category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker"  name="unit" id="main_category_id" data-live-search="true" required>
                                    ...
                                    <option @if ($unit->id == $product->unit) selected @endif value="{{ $unit->id }}">{{ $unit->name}}</option>                     
                                    @endforeach
                                </select>
                            </div>
                        </div>
