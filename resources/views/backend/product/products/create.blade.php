            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Small Summary')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="small_summary" placeholder="{{ translate('Small Summary') }}"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="main_category">
                            <label class="col-md-3 col-from-label">{{translate('Main Category')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" onchange="update_children()" name="main_category_id" id="main_category_id" data-live-search="true" required>
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="category_id" id="category_id" data-live-search="true"  required>
                                    ...
                                    @foreach ($categories[0]->childrenCategories as $childCategory)
                                    <option  value="{{ $childCategory->id }}">{{ $childCategory->getTranslation('name') }}</option>                     
                                    @foreach ($childCategory->childrenCategories as $thechildCategory)
                        ...
                        <div class="form-group row" id="main_category">
                            <label class="col-md-3 col-from-label">{{translate('Cities/Locations')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker"  name="cities[]" id="cities" data-live-search="true" multiple required>
                        ...
                        <div class="form-group row" id="main_category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker"  name="unit" id="main_category_id" data-live-search="true" required>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <small class="text-muted d-none">{{translate('These images are visible in product details page gallery. Use 600x600 sizes images.')}}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <small class="text-muted d-none">{{translate('This image is visible in all product box. Use 300x300 sizes image. Keep some blank space around main object of your image as we had to crop some edge in different devices to make it responsive.')}}</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <input type="hidden" class="form-control" id="custom_options" name="custom_options" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="customer_choice_options d-none" id="customer_choice_options">
...
<!--                <div class="card">
            ...
            <div class="col-12">
                <div class="btn-toolbar float-right mb-3" role="toolbar" aria-label="Toolbar with button groups">
                    <div class="btn-group mr-2 d-none" role="group" aria-label="First group">
...
<script type="text/javascript">
    ...
    function add_more_customer_choice_option2(i, name){
        $.ajax({
            ...
            type:"POST",
            url:'{{ route('products.add-more-choice-option2') }}',
            data:{
               attribute_ids: i
            },
            success: function(data) {
                $('#customer_choice_options2').html(data);
                AIZ.uploader.previewGenerate();
                AIZ.plugins.fooTable();
                if (data.length > 1) {
                   $('#customer_choice_options2').show();
                }
                else {
                    $('#customer_choice_options2').hide();
                }

               var inputlist =$('#customer_choice_options2').find("input[name^='price_attr_id_']");
               var selected_attribute_values=[];
               for (var i = 0; i < inputlist.length; i++) {
                var temp_name=inputlist[i].name;
                var temp_value=inputlist[i].value;
                var attribute_value_id=temp_name.replace("price_attr_id_","");
                var temp_array=[];
                let temp_opj={
                    'id':attribute_value_id,
                    'price':temp_value
                }
                 /*   temp_array['id']=attribute_value_id;
                    temp_array['price']=temp_value;*/

                  //  temp_opj= JSON.stringify(temp_opj);
               //console.log(temp_opj);
                selected_attribute_values.push(temp_opj);
               ...
               selected_attribute_values= JSON.stringify(selected_attribute_values);
               console.log(selected_attribute_values);
               $('#custom_options').val(selected_attribute_values);
 ...
 /*$.ajax({
      headers: {
            ...
            success: function(data) {
                ...
                <div class="form-group row">\
                    ...
                    <div class="col-md-8">\
                        <select sel class="form-control aiz-selectpicker attribute_choice" data-live-search="true" name="choice_options_'+ i +'[]" multiple>\
                            '+obj+'\
                        </select>\
                    </div>\
                </div>');
    ...
    function update_children(){
        console.log("fff");
  //  $('input[name="main_category_id"]').on('change', function() {
    ...
    $('#choice_attributes').on('change', function() {
        ...
        $.each($("#choice_attributes option:selected"), function(){
            ...
            att_ids.push($(this).val());
        });
        
        add_more_customer_choice_option2(att_ids, $(this).text());
