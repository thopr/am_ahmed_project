          ...
          <div class="card-body p-0">
              ...
              <form class="p-4" action="{{ route('cities.update', $city->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="text" placeholder="{{translate('latitude')}}" name="latitude" value="{{ $city->latitude }}" class="form-control" required>
                </div>
                <div class="form-group mb-3">
                    <label for="name">{{translate('Longitude')}}</label>
                    <input type="text" placeholder="{{translate('longitude')}}" name="longitude" value="{{ $city->longitude }}" class="form-control" required>
                </div>
                <div class="form-group mb-3">
                    <label for="name">{{translate('Summary')}}</label>
                    <input type="text" placeholder="{{translate('summary')}}" name="summary" value="{{ $city->summary }}" class="form-control" required>
                </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
                <div class="input-group" data-toggle="aizuploader" data-type="image">
                    ...
                    <input type="hidden" name="image" value="{{$city->image}}" class="selected-files">
                </div>
