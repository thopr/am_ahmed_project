                        ...
                        <tbody>
                            @foreach($cities as $key => $city)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ uploaded_asset($city->image) }}" alt="{{translate('city')}}"
                                         height="50" width="50" 
                                        class="h-50px"
                                    ...
                                    <td>
                                      ...
                                      <td>
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                          <input onchange="update_featured(this)" value="{{ $city->id }}" type="checkbox" <?php if($city->featured == 1) echo "checked";?> >
                                          <span class="slider round"></span>
                                        </label>
                                      </td>
                                                                          <td class="text-right">
...
@section('script')
    <script type="text/javascript">
        ...
        function update_featured(el){
            ...
            $.post('{{ route('cities.featured') }}', {_token:'{{ csrf_token() }}', id:el.value, featured:featured}, function(data){
                if(data == 1){
