...
Route::get('/login/loginjustphone', 'HomeController@loginjustphone3')->name('loginjustphone');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/products/add-more-choice-option2', 'ProductController@add_more_choice_option2')->name('products.add-more-choice-option2');

    Route::get('invoice/{order_id}', 'InvoiceController@invoice_download')->name('invoice.download');
    Route::post('/orders/notify_delivery_person', 'OrderController@notify_delivery_person')->name('orders.notify_delivery_person');
    Route::post('/orders/send_qr_invoice', 'OrderController@send_qr_invoice')->name('orders.send_qr_invoice');
    ...
    Route::post('/orders/update_delivery_person', 'OrderController@update_delivery_person')->name('orders.update_delivery_person');
