...
Route::group(['prefix' => 'v2/auth', 'middleware' => ['app_language']], function() {
    Route::post('loginjustphone', 'Api\V2\AuthController@loginjustphone');
    Route::post('loginjustphone2', 'Api\V2\AuthController@loginjustphone2');
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    ...
    Route::get('zones/check_zone', 'ZoneController@check_zone');
    Route::get('zones', 'ZoneController@zones');
    ...
    Route::get('business-settings/type', 'Api\V2\BusinessSettingController@get_by_type');

  
    Route::get('categories/main', 'Api\V2\CategoryController@main');
    ...
    Route::get('pick_up_points', 'HomeController@pick_up_points');
    ...
    Route::post('complete_tap_payment', 'Api\V2\OrderController@complete_tap_payment');
