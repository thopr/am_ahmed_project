...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::post('/categories/children', 'CategoryController@children')->name('categories.children');
    ...
    Route::get('/units/destroy/{id}', 'UnitController@destroy')->name('units.destroy');
    ...
    Route::get('/business-settings/slider', 'BusinessSettingsController@slider')->name('business_settings.slider');
    ...
    // All Orders
    Route::get('/purchase_list', 'OrderController@purchase_list')->name('purchase_list');
    Route::get('/orders_list', 'OrderController@orders_list')->name('orders_list');
	...
	Route::post('/states/featured', 'StateController@updateFeatured')->name('states.featured');


    

    Route::get('/slider', 'CityController@edit')->name('cities.edit');
    ...
    Route::post('/cities/featured', 'CityController@updateFeatured')->name('cities.featured');
